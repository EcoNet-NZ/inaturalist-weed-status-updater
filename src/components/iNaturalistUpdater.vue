  ...
  data() {
    return {
      ...
      treatmentSubstances: [
        ...
        { name: "Triumph Gel / Vigilant",      code: "Triumph Gel / Vigilant" },        
        { name: 'Weed Weapon Invade Gel',      code: 'Weed Weapon Invade Gel' },
        { name: 'Weed Weapon Stump-Stop-Gel',  code: 'Weed Weapon Stump-Stop-Gel' },
        { name: 'OTHER GEL',                   code: 'OTHER GEL' },
        { name: 'Glyphosate Spray',            code: 'Glyphosate Spray' },
        { name: 'Haloxyfop Spray',             code: 'Haloxyfop Spray' },
        { name: 'MetSulf Spray',               code: 'MetSulf Spray' },
        { name: 'Triclopyr Spray',             code: 'Triclopyr Spray' },
        { name: 'OTHER LIQUID Herbicide',      code: 'OTHER LIQUID Herbicide' },
        { name: 'Glyphosate Granules',         code: 'Glyphosate Granules' },
  ...
  methods: {
    ...
    createJsonBody() {
      ...
      if (this.controlled) {
        ...
        if (this.initialDeprecatedDateForNextVisit)                     fields[OBSERVATION_FIELD_ID['deprecatedDateForNextVisit']] = "(undef.)" // Always delete if set
      } else {
